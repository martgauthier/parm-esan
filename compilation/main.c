...
void parse_instruction(const char* instruction, char* command, char* arg1, char* arg2, char* arg3, int *isImm) {
    ...
    *(arg3+arg3Pos)='\0';
    ...
    if(strlen(arg3) == 5 || strlen(arg3) == 8 || strlen(arg2) == 5 || strlen(arg2) == 8) {
        *isImm=1;
    }
    else {
        *isImm=0;
...
void processInstruction(const char *instruction, struct Dictionary *dict) {
    ...
    parse_instruction(instruction, command, arg1, arg2, arg3, &isImm);
...
int main() {
    ...
    const char *instruction1 = "ands r3, r1";
